...
```
Combining the above blocks into a single data wrangling sequence for average deviation and covariance w/ richness.
...
ggplot(data = species_by_plot_gg, aes(x = obs_cov_eff, y = obs_mean_eff, color = site_id)) +
  geom_point() +
  geom_hline(yintercept = 0, linetype = "dashed") +
  geom_vline(xintercept = 0, linetype = "dashed") +
  geom_hline(aes(yintercept = lower_mean, color = site_id), linetype = "dashed") +
  geom_hline(aes(yintercept = upper_mean, color = site_id), linetype = "dashed") +
  geom_vline(aes(xintercept = lower_cov, color = site_id), linetype = "dashed") +
  geom_vline(aes(xintercept = upper_cov, color = site_id), linetype = "dashed") +
  facet_wrap(vars(plot_id)) +
  theme_bw()
